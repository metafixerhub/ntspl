...
>(({ className, ...props }, ref) => (
  <motion.div
    ref={ref}
    className={cn(
      "rounded-xl border bg-card/60 backdrop-blur-md text-card-foreground shadow-lg relative overflow-hidden",
      "hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10 transition-shadow duration-300",
